 ...
 *         &lt;element name="dividendEntitlement" type="{http://www.fpml.org/FpML-5/reporting}DividendEntitlementEnum" minOccurs="0"/>
 *         &lt;element name="dividendAmount" type="{http://www.fpml.org/FpML-5/reporting}DividendAmountTypeEnum" minOccurs="0"/>
 *         &lt;element name="dividendPaymentDate" type="{http://www.fpml.org/FpML-5/reporting}DividendPaymentDate" minOccurs="0"/>
 *         &lt;choice>
 *           &lt;sequence>
 *             &lt;element name="dividendPeriodEffectiveDate" type="{http://www.fpml.org/FpML-5/reporting}DateReference" minOccurs="0"/>
 *             &lt;element name="dividendPeriodEndDate" type="{http://www.fpml.org/FpML-5/reporting}DateReference" minOccurs="0"/>
 *           &lt;/sequence>
 *           &lt;element name="dividendPeriod" type="{http://www.fpml.org/FpML-5/reporting}DividendPeriodEnum" minOccurs="0"/>
 *         &lt;/choice>
 *         &lt;element name="extraOrdinaryDividends" type="{http://www.fpml.org/FpML-5/reporting}PartyReference" minOccurs="0"/>
 *         &lt;element name="excessDividendAmount" type="{http://www.fpml.org/FpML-5/reporting}DividendAmountTypeEnum" minOccurs="0"/>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/reporting}CurrencyAndDeterminationMethod.model" minOccurs="0"/>
 *         &lt;element name="dividendFxTriggerDate" type="{http://www.fpml.org/FpML-5/reporting}DividendPaymentDate" minOccurs="0"/>
 *         &lt;element name="interestAccrualsMethod" type="{http://www.fpml.org/FpML-5/reporting}InterestAccrualsCompoundingMethod" minOccurs="0"/>
 *         &lt;element name="numberOfIndexUnits" type="{http://www.fpml.org/FpML-5/reporting}NonNegativeDecimal" minOccurs="0"/>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/reporting}DeclaredCashAndCashEquivalentDividendPercentage.model"/>
 *         &lt;element name="nonCashDividendTreatment" type="{http://www.fpml.org/FpML-5/reporting}NonCashDividendTreatmentEnum" minOccurs="0"/>
 *         &lt;element name="dividendComposition" type="{http://www.fpml.org/FpML-5/reporting}DividendCompositionEnum" minOccurs="0"/>
